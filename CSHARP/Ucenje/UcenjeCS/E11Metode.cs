...
namespace UcenjeCS
{
    internal class E11Metode
    {
        ...
        public static void Izvedi()
        {
            ...
            int broj = Tip3();
            Console.WriteLine(broj); // vraća ascii vrijednost, alt + na numeričkoj tipkovnici daje neki znak
        ...
        // Tip2. metoda prima parametre i ne vraća vrijednost
        // kada ispred [static] void nema načina pristupa tada je private

        static void Tip2(string ime = "Nije postavljeno")
        {
